...
#definition of the cylinder geometry
#(geo is set by points going around the angular range btwn 0 and 2pi
R=1.0
...
#Create NumPy array of size NP
Np=10               #number of pannels desired
