...
plt.scatter(source.x,source.y,c='g',s=80,marker='^')
plt.scatter(sourceImage.x,sourceImage.y,c='g',s=80,marker='D')
...
v = vortex2.v + vortex2.v + vortexImage1.v + vortexImage2.v
...
plt.streamplot(X,Y,u,v,\
        density=2.0,linewidth=1,arrowsize=1,arrowstyle='->')
plt.scatter(vortex1.x,vortex1.y,c='c',s=80,marker='o')
plt.scatter(vortex2.x,vortex2.y,c='g',s=80,marker='o')
plt.scatter(vortexImage1.x,vortexImage1.y,c='c',s=80,marker='D')
